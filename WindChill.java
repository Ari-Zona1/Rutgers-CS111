...
public class WindChill {
	...
	//Stores all the numbers into a double var by converting a string into a double
    double temp = Double.parseDouble(args[0]); 
	double velocity = Double.parseDouble(args[1]); 
	
    //Intialize wind chill
    double windChill;

	//Perform the equation -> w = 35.74 + 0.6215 * Temp + (0.4275 * Temp - 35.75) velocity^0.16
